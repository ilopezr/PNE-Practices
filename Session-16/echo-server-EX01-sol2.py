...
class TestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if self.path == "/":
            ...
            #print("parse_qs", parse_qs(urlparse(self.path).query)) # {'msg': ['dfdfdf']}
            message = parse_qs(urlparse(self.path).query)["msg"][0] #estamos cogiendo el mensaje de este diccionario {'msg': ['dfdfdf']}
